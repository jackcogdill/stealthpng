 ...
 * For security, there is no way of knowing if the decryption was successful. If you don't have the password, the resulting data will just be a bunch of garbage
